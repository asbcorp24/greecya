...
use App\Http\Controllers\Admin\PanoramaController as AdminPanoramaController;
...
Route::prefix('admin')->name('admin.')->middleware(['auth','admin','audit.admin'])->group(function(){
    ...
    Route::get('/panoramas',[AdminPanoramaController::class,'index'])->name('panoramas.index');Route::post('/panoramas',[AdminPanoramaController::class,'store'])->name('panoramas.store');Route::patch('/panoramas/{panorama}',[AdminPanoramaController::class,'update'])->name('panoramas.update');Route::delete('/panoramas/{panorama}',[AdminPanoramaController::class,'destroy'])->name('panoramas.destroy');

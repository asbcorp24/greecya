...
Route::middleware('guest')->group(function(){Route::get('/login',[AuthController::class,'create'])->name('login');Route::post('/login',[AuthController::class,'store'])->name('login.store');Route::get('/account/register',[AccountAuthController::class,'create'])->name('account.register');Route::post('/account/register',[AccountAuthController::class,'store'])->name('account.register.store');});
Route::post('/logout',[AuthController::class,'destroy'])->middleware('auth')->name('logout');
Route::prefix('account')->name('account.')->middleware(['auth','customer'])->group(function(){Route::get('/',[AccountController::class,'dashboard'])->name('dashboard');Route::patch('/profile',[AccountController::class,'updateProfile'])->name('profile.update');Route::post('/progress',[AccountController::class,'storeProgress'])->name('progress.store');});
...
Route::prefix('admin')->name('admin.')->middleware(['auth','admin'])->group(function(){
    ...
    Route::get('/inventory',[AdminInventoryController::class,'index'])->name('inventory.index');Route::post('/inventory',[AdminInventoryController::class,'store'])->name('inventory.store');Route::post('/inventory/{item}/movements',[AdminInventoryController::class,'movement'])->name('inventory.movements.store');

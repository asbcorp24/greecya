...
return [
    ...
    'permissions' => [
        ...
        'services.view'=>['Просмотр услуг комплекса','Услуги'],'services.manage'=>['Создание и изменение услуг комплекса','Услуги'],
    ...
    'route_permissions' => [
        ...
        'admin.services.index'=>['*'=>'services.view'],'admin.services.*'=>['*'=>'services.manage'],

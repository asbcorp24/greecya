...
return [
    ...
    'permissions' => [
        'crm.access'=>['Доступ в CRM','Система'],'dashboard.view'=>['Просмотр главного экрана','Система'],'permissions.manage'=>['Управление ролями и правами','Система'],'audit.view'=>['Просмотр аудита действий','Система'],
        ...
        'cash.view'=>['Просмотр кассы','Финансы'],'cash.manage'=>['Кассовые операции','Финансы'],'cash.refund'=>['Возвраты денежных средств','Финансы'],'orders.view'=>['Просмотр заказов','Финансы'],'orders.manage'=>['Изменение заказов и оплат','Финансы'],'reports.view'=>['Просмотр финансовых и управленческих отчётов','Финансы'],
        'products.view'=>['Просмотр товаров и тарифов','Продажи'],'products.manage'=>['Изменение товаров, цен и тарифов','Продажи'],'certificates.view'=>['Просмотр сертификатов','Продажи'],'certificates.manage'=>['Выдача и изменение сертификатов','Продажи'],'certificates.redeem'=>['Погашение сертификатов','Продажи'],'leads.view'=>['Просмотр лидов','Продажи'],'leads.manage'=>['Управление лидами','Продажи'],
    ...
    'route_permissions' => [
        ...
        'admin.permissions.*'=>['*'=>'permissions.manage'],'admin.audit.*'=>['*'=>'audit.view'],'admin.dashboard'=>['*'=>'dashboard.view'],
